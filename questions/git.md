...
Git-flow — альтернативная модель ветвления Git, в которой используются долгосрочные функциональные ветки и несколько основных веток. В Git-flow используется больше веток, их срок жизни дольше, а коммиты в них крупнее, чем в модели магистральной разработки.
